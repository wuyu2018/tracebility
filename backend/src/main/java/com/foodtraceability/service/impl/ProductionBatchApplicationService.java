...
@Service
public class ProductionBatchApplicationService implements ProductionBatchService {
    ...
    private ProductionBatch createBatchEntity(ProductionBatchDTO dto, Product product) {
        ProductionBatch batch = ProductionBatch.create(
                ...
                dto.getShelfLife() != null ? dto.getShelfLife() : product.getShelfLife()
        );
    ...
    private void associateStorage(ProductionBatch batch, StorageDTO storageDto) {
        ...
        Storage storage = Storage.create(
                batch,
                storageDto.getStorageTime(),
                storageDto.getWarehouseLocation(),
    ...
    private void associateTransportSale(ProductionBatch batch, TransportSaleDTO transportSaleDto) {
        ...
        TransportSale transportSale = TransportSale.create(
                batch,
                transportSaleDto.getTime(),
                transportSaleDto.getTransportCompany(),
                transportSaleDto.getVehicleNumber(),
                transportSaleDto.getReceiverName(),
                transportSaleDto.getReceiverContact(),
                transportSaleDto.getSalesRegion(),
                transportSaleDto.getEnvironmentTemperature(),
                transportSaleDto.getProductTemperature()
        );
    ...
    public TransportSaleDTO addTransportSale(Long batchId, TransportSaleDTO dto) {
        ...
        TransportSale transportSale = TransportSale.create(
                batch,
                dto.getTime(),
                dto.getTransportCompany(),
                dto.getVehicleNumber(),
                dto.getReceiverName(),
                dto.getReceiverContact(),
                dto.getSalesRegion(),
                dto.getEnvironmentTemperature(),
                dto.getProductTemperature()
        );
        transportSale = transportSaleRepository.save(transportSale);
