...
public class SmartDatabaseInitializer implements CommandLineRunner {
    ...
    private void initializeData() {
        ...
        inspectionRepository.saveAll(List.of(
            Inspection.create(batch1, "有机纯牛奶", 50, "250ml/盒", "/img/inspections/placeholder.svg"),
            Inspection.create(batch2, "有机橄榄油", 30, "500ml/瓶", "/img/inspections/placeholder.svg"),
            Inspection.create(batch3, "有机蜂蜜", 20, "350g/瓶", "/img/inspections/placeholder.svg")
        ));
