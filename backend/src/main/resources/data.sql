...
-- 原料采购 (使用product_name和batch_number)
...
-- 贮存记录 (使用product_name和batch_number)
...
-- 出厂检验 (使用product_name和batch_number)
...
-- 储运销售 (使用product_name和batch_number)
...
-- 投诉信息 (仍使用product_id，因为Complaint实体保持不变)
