<template>
  <div class="data-management">
    <el-card class="main-card">
      <template #header>
        <div class="card-header">
          <h1>生产数据管理</h1>
          <p class="subtitle">产品信息 → 原材料 → 生产批次 → 防伪码</p>
        </div>
      </template>
      ...
      <el-steps :active="currentStep" finish-status="success" class="main-steps">
        ...
        <el-step title="生产批次" description="创建生产批次" />
    ...
    <el-dialog v-model="batchDetailVisible" title="批次详情 + 质检报告" width="700px">
